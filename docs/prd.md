...
- 切换影响范围：页面内所有文字（店名、菜系、地址、引导语等）
- 书脊/封面文字始终中英双行展示，不受切换影响

#### 非中文城市（济州岛、吉隆坡）

- 页面右上角**不显示语言切换按钮**
- 所有文字内容自动同时展示多语言，固定顺序：**本国语言 → 英文 → 中文**
...
- 背景：纯白
- 页面右上角：EN/CN 语言切换按钮（仅在中国城市详情页显示；首页书架始终显示，切换书脊/封面文字语言）
...
- 书脊文字：竖向排列，格式：
  ...
  China · Dalian
  ```
  中文用霞鹜文楷，英文用 Playfair Display
- 书脊上方：城市代表贴纸（SVG）
- 书本封面（悬停时可见）：横向文字，同书脊格式
...
- 页面右上角 EN/CN 切换按钮（书架页可见，切换书脊文字语言）
