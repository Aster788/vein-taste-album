...
| --- | ---- | ------------ | ---- | ----- | ------- |
| 1   | 大连   | Dalian       | 中国   | 中文城市  | `dalian` |
| 2   | 青岛   | Qingdao      | 中国   | 中文城市  | `qingdao` |
| 3   | 上海   | Shanghai     | 中国   | 中文城市  | `shanghai` |
| 4   | 南京   | Nanjing      | 中国   | 中文城市  | `nanjing` |
| 5   | 苏州   | Suzhou       | 中国   | 中文城市  | `suzhou` |
| 6   | 广州   | Guangzhou    | 中国   | 中文城市  | `guangzhou` |
| 7   | 重庆   | Chongqing    | 中国   | 中文城市  | `chongqing` |
| 8   | 福州   | Fuzhou       | 中国   | 中文城市  | `fuzhou` |
| 9   | 厦门   | Xiamen       | 中国   | 中文城市  | `xiamen` |
| 10  | 泉州   | Quanzhou     | 中国   | 中文城市  | `quanzhou` |
| 11  | 济州岛  | Jeju         | 韩国   | 多语言城市 | `jeju` |
| 12  | 吉隆坡  | Kuala Lumpur | 马来西亚 | 多语言城市 | `kuala-lumpur` |
| 13  | 马六甲  | Melaka       | 马来西亚 | 多语言城市 | `melaka` |

> 书架横向排列顺序以 `src/utils/citySlugs.js` 中 `CITY_SLUGS` 为准（与上表编号不同）。
...
- 配置全局 CSS 变量（12 套城市配色 token、字体变量、纸质纹理）
...
- 填入其余城市数据（GeoJSON + restaurants + dishes + 图片）
- 整体贴纸位置微调
