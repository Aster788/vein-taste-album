...
| 人工检查结果                      | warning 1 ✅️ | react-router-dom.js?v=dd146586:4434 ⚠️ React Router Future Flag Warning: React Router will begin wrapping state updates in `React.startTransition` in v7. You can use the `v7_startTransition` future flag to opt-in early. For more information, see [https://reactrouter.com/v6/upgrading/future#v7_starttransition](https://reactrouter.com/v6/upgrading/future#v7_starttransition). warnOnce @ react-router-dom.js?v=dd146586:4434 react-router-dom.js?v=dd146586:4434 |
| 人工检查结果                      | warning 2 ✅️ | ⚠️ React Router Future Flag Warning: Relative route resolution within Splat routes is changing in v7. You can use the `v7_relativeSplatPath` future flag to opt-in early. For more information, see [https://reactrouter.com/v6/upgrading/future#v7_relativesplatpath](https://reactrouter.com/v6/upgrading/future#v7_relativesplatpath). warnOnce @ react-router-dom.js?v=dd146586:4434                                                                                   |
