...
export const CUISINE_BY_EN = Object.freeze({
  ...
  "chuan-cuisine": { zh: "川菜", en: "sichuan cuisine", ko: "사천 요리" },
  coffee: { zh: "咖啡", en: "coffee", ko: "커피" },
  dessert: { zh: "甜品", en: "dessert", ko: "디저트" },
  "fast-food": { zh: "快餐", en: "fast food", ko: "패스트푸드" },
  "fujian-cuisine": { zh: "闽菜", en: "fujian cuisine", ko: "복건 요리" },
  "fusion-cuisine": { zh: "融合菜", en: "fusion cuisine", ko: "퓨전 요리" },
  grill: { zh: "烤肉", en: "grill", ko: "구이" },
  "guizhou-cuisine": { zh: "黔菜", en: "guizhou cuisine", ko: "구이저우 요리" },
  hotpot: { zh: "火锅", en: "hotpot", ko: "훠궈" },
  "hunan-cuisine": { zh: "湘菜", en: "hunan cuisine", ko: "후난 요리" },
  "ice-cream": { zh: "冰淇淋", en: "ice cream", ko: "아이스크림" },
  "italian-cuisine": { zh: "意大利菜", en: "italian cuisine", ko: "이탈리아 요리" },
  "japanese-cuisine": { zh: "日料", en: "japanese cuisine", ko: "일식" },
  "jiangsu-cuisine": { zh: "苏菜", en: "jiangsu cuisine", ko: "장쑤 요리" },
  "jiangxi-cuisine": { zh: "赣菜", en: "jiangxi cuisine", ko: "강시 요리" },
  juice: { zh: "果汁", en: "juice", ko: "주스" },
  "korean-cuisine": { zh: "韩餐", en: "korean cuisine", ko: "한식" },
  "light-meal": { zh: "轻食", en: "light meal", ko: "가벼운 식사" },
  "milk-tea": { zh: "奶茶", en: "milk tea", ko: "밀크티" },
  noodle: { zh: "面食", en: "noodles", ko: "면류" },
  "northeast-cuisine": {
    zh: "东北菜",
    en: "northeastern chinese cuisine",
    ko: "중국 동북 요리",
  },
  "northwest-cuisine": { zh: "西北菜", en: "northwest chinese cuisine", ko: "중국 서북 요리" },
  other: { zh: "其他", en: "other", ko: "기타" },
  pastry: { zh: "糕点", en: "pastry", ko: "제과" },
  "portuguese-cuisine": { zh: "葡萄牙菜", en: "portuguese cuisine", ko: "포르투갈 요리" },
  "russian-cuisine": { zh: "俄罗斯菜", en: "russian cuisine", ko: "러시아 요리" },
  seafood: { zh: "海鲜", en: "seafood", ko: "해산물" },
  "shandong-cuisine": { zh: "鲁菜", en: "shandong cuisine", ko: "산둥 요리" },
  "shanghai-cuisine": { zh: "沪菜", en: "shanghai cuisine", ko: "상하이 요리" },
  snacks: { zh: "零食", en: "snacks", ko: "간식" },
  "south-asian-cuisine": { zh: "南亚菜", en: "south asian cuisine", ko: "남아시아 요리" },
  "southeast-asian-cuisine": {
    zh: "东南亚菜",
    en: "southeast asian cuisine",
    ko: "동남아 요리",
  },
  "spanish-cuisine": { zh: "西班牙菜", en: "spanish cuisine", ko: "스페인 요리" },
  steak: { zh: "牛排", en: "steak", ko: "스테이크" },
  "street-food": { zh: "街头小吃", en: "street food", ko: "길거리 음식" },
  "western-cuisine": { zh: "西式", en: "western cuisine", ko: "양식" },
  "xinjiang-cuisine": { zh: "新疆菜", en: "xinjiang cuisine", ko: "신장 요리" },
  yogurt: { zh: "酸奶", en: "yogurt", ko: "요거트" },
  "yunnan-cuisine": { zh: "滇菜", en: "yunnan cuisine", ko: "윈난 요리" },
  "zhejiang-cuisine": { zh: "浙菜", en: "zhejiang cuisine", ko: "절강 요리" },
});
